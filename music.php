<? $view='music'; require_once('top.php'); ?>

			<div id="music" class="row activePage">
				<h2 style="color:white">Original Music Projects:</h2>
				<div class="row">
					<div class="musicItem col-md-8 blogItem">
						<h3>Star Service</h3>
						<i>Synth-pop / Space Opera / Electronic</i><br>
					        <iframe width="100%" height="300" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/388421664&color=%23ff5500&auto_play=false&hide_related=true&show_comments=true&show_user=true&show_reposts=false"></iframe>
				        </div>
					<div class="musicItem col-md-8 blogItem">
						<h3>The New Time</h3>
